...
public class GeneralConfig {
    ...
    @Value("${sdk.url.faceUrl}")
    private String faceUrl;

    @Value("${sdk.url.analyseUrl}")
    private String analyseUrl;

    @Value("${sdk.staticGallery}")
    private String staticGallery;

    @Value("${sdk.url.facesUrl}")
    private String facesUrl;

    @Value("${sdk.url.analyseMetaUrl}")
    private String analyseMetaUrl;

    @Value("${sdk.url.identifyUrl}")
...
//    private int cameraHeight;
    ...
    @Value("${sysconfig.storage_url}")
    private String storage_url;
    @Value("${sysconfig.default_thresold}")
    private String default_threold;
...
//    }
    ...
    public String getDefault_threold() {
        return default_threold;
    }
    ...
    public String getAnalyseMetaUrl() {
        return analyseMetaUrl;
    }
